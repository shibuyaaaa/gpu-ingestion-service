...
def _source_audio_cache_status(path: Path, *, enabled: bool, max_entries: int) -> dict[str, Any]:
...
def _analysis_cache_status(path: Path, *, enabled: bool, max_entries: int) -> dict[str, Any]:
