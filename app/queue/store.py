                        ...
                        **durations,
                        "timings": _timing_subset(
                            ...
                            [
                                ...
                                "source_audio_cache_wait_seconds",
                                "source_audio_cache_restore_seconds",
                                "source_audio_cache_copy_seconds",
                                "source_audio_cache_build_copy_seconds",
                                "source_audio_cache_build_convert_seconds",
                                "source_audio_cache_store_seconds",
                                "wav_copy_seconds",
                                "wav_convert_seconds",
                        ...
                        **durations,
                        "timings": _timing_subset(
                            ...
                            [
                                ...
                                "byproduct_setup_seconds",
                                "find_analysis_json_seconds",
                                "load_analysis_json_seconds",
                                "find_demix_stems_seconds",
                                "demix_backend",
                                "demix_track_count",
                                "demix_existing_tracks",
                                "demix_pending_tracks",
                                "demix_model_ready_seconds",
                                "demix_total_seconds",
                                "demix_cli_seconds",
                                "demix_apply_seconds",
                                "demix_audio_read_seconds",
                                "demix_normalize_seconds",
                                "demix_pin_seconds",
                                "demix_transfer_seconds",
                                "demix_save_seconds",
                                "demix_segment_seconds",
                                "demix_segment_configured_seconds",
                                "demix_segment_max_seconds",
                                "demix_overlap",
                                "analysis_cache_hit",
                                "analysis_cache_wait_seconds",
                                "analysis_cache_restore_seconds",
                                "analysis_cache_store_wait_seconds",
                                "analysis_cache_store_seconds",
                                "fanout_enqueue_seconds",
                                "fanout_child_count",
                                "fanout_chord_child_count",
                                "fanout_other_child_count",
                                "gpu_sample_count",
                                "gpu_utilization_avg_pct",
                                "gpu_utilization_max_pct",
                                "gpu_memory_used_max_mb",
                                "stem_count",
                            ],
                        ),
                    }
                    ...
                    **durations,
                    "timings": _timing_subset(
                        ...
                        [
                            ...
                            "segment_stem_cache_partial_hit",
                            "segment_stem_cache_partial_hit_count",
                            "segment_stem_cache_restore_seconds",
                            "segment_stem_cache_store_seconds",
                            "segment_output_url_cache_hit",
                            "segment_output_url_cache_stem_count",
                            "source_segment_extract_seconds",
                            "gcs_segment_upload_memory_cache_hit_count",
                            "gcs_segment_upload_disk_cache_hit_count",
        ...
        return {
            ...
            "analyze": _aggregate_timing_rows(
                ...
                [
                    ...
                    "gpu_sample_elapsed_seconds",
                    "gpu_utilization_avg_pct",
                    "gpu_utilization_max_pct",
                    "gpu_memory_used_avg_mb",
                    "gpu_memory_used_max_mb",
                    "gpu_memory_free_min_mb",
                    "queue_wait_seconds",
                    "processing_seconds",
                    "duration_seconds",
                ],
